...
- **Do** theme the browser surfaces (selection, caret, scrollbars, focus ring) from the same palette; all four already ship themed, and the ring turns Plate Blue on graphite.
